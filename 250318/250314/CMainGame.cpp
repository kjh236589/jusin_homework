...
void CMainGame::Initialize()
{
	...
	m_ObjList[OBJ_MAP].push_back(CAbstractFactory<CMap>::Create_Obj(WINCX / 2.f, WINCY - 50.f));
	m_ObjList[OBJ_MAP].push_back(CAbstractFactory<CMap>::Create_Obj(WINCX / 4.f, WINCY - 200.f));
...
void CMainGame::Late_Update()
{
	...
	CCollisionMgr::Collision_Rect(m_ObjList[OBJ_PLAYER], m_ObjList[OBJ_MAP]);
	CCollisionMgr::Collision_Rect(m_ObjList[OBJ_MONSTER], m_ObjList[OBJ_MAP]);
	CCollisionMgr::Collision_Rect(m_ObjList[OBJ_BULLET], m_ObjList[OBJ_MAP]);
	CCollisionMgr::Collision_Rect(m_ObjList[OBJ_MAP], m_ObjList[OBJ_ITEM]);
